...
import com.example.lianyungang.common.DocumentHandler;
...
//        WordUtil.createWord(rep, "wangdong.xml", filePath, filename);
        WordUtil.createWord(wordout, "wangdong.xml", filePath, filename);

    }

    @Test
    public void testCreateDoc() throws UnsupportedEncodingException {
